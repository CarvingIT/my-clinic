<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Branch Selection -->
        <div class="mt-4 ">
            <x-input-label for="branch_id" :value="__('OPD')" />


            <div class="relative">  </div> <div class="inline-block align-middle mr-2"> जातेगांवकर  चिकित्सालय - </div>
            <select id="branch_id" name="branch_id"
                class="inline-block w-auto rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                required>
