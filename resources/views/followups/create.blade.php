                        ...
                        <div class="lg:col-span-1">
                            @php
                                ...
                                foreach ($followUps as $followUp) {
                                    $checkUpInfoVal = json_decode($followUp->check_up_info, true) ?? [];
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2">
                            <form method="POST" action="{{ route('followups.store') }}" enctype="multipart/form-data"
                                ...
                                @include('followups.form-fields', ['isEdit' => false])
                            </form>
                        </div>
                                    ...
                                    <div class="space-y-4">
                                        @foreach ($followUps as $followUp)
                                            <div
                                                ...
                                                @php $checkUpInfoVal = json_decode($followUp->check_up_info, true); @endphp
                                                <div
