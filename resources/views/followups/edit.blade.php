                                ...
                                <div class="mb-6">
                                    ...
                                    <div id="nadiGrid" class="mt-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 p-2 rounded shadow-lg flex gap-2 justify-center items-center">
                                        ...
                                        @if($nadiGridType === '5x1')
                                            ...
                                            @for($box = 0; $box < 3; $box++)
                                                <div class="grid grid-cols-5 gap-0 bg-gray-100 dark:bg-gray-600 p-1 rounded">
                                                    @for($i = 0; $i < 5; $i++)
                                                        <div class="w-5 h-5 cursor-pointer flex items-center justify-center bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition {{ $i < 4 ? 'border-r border-gray-300 dark:border-gray-500' : '' }}" 
                                        ...
                                        @else
                                            ...
                                            @for($box = 0; $box < 3; $box++)
                                                <div class="grid grid-cols-3 gap-0 bg-gray-100 dark:bg-gray-600 p-1 rounded">
                                                    @for($i = 0; $i < 9; $i++)
                                                        <div class="w-5 h-5 cursor-pointer flex items-center justify-center bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition {{ $i % 3 != 2 ? 'border-r border-gray-300 dark:border-gray-500' : '' }} {{ $i < 6 ? 'border-b border-gray-300 dark:border-gray-500' : '' }}" 
                                                             onclick="toggleDot(this, {{ $box }}, {{ $i }})"></div>
                                                    @endfor
                                                </div>
                                            @endfor
