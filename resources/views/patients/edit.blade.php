                            ...
                            <form method="POST" action="{{ route('patients.update', $patient->id) }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="occupation" class="block mt-1 w-full" type="text"
                                        name="occupation" :value="$patient->occupation" required />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="mobile_phone" class="block mt-1 w-full" type="text"
                                        name="mobile_phone" :value="$patient->mobile_phone" required />
