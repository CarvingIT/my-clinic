    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            .prescription-page { border: none; border-radius: 0; box-shadow: none; margin: 0; }
...
<body>
    ...
    <div class="print-toolbar">
        ...
        <button class="btn-download" onclick="window.location.href='{{ route('followups.prescription', $followup_id) }}'">
            📥 Download PDF
        </button>
